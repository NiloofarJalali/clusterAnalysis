...
#   ObservationData= RJDBC::dbGetQuery(conn,"SELECT * from ASD_GI.A00026337_OBSERVATION_FACT WHERE CONCEPT_CD LIKE 'ICD9:%'")
#   demogData=RJDBC::dbGetQuery(conn,"select * from ASD_GI.A00026337_PATIENT_DIM")
#   conceptData=RJDBC::dbGetQuery(conn,"select * from ASD_GI.CONCEPT_DIMENSION")
#
#   if( verbose == TRUE ){
