...
#' #'@param input  the dataframe that need to be clustered (The patientd ID and phenotype are used)
#' #'@param clusterSubject A vector of phenotypes or ICD-9 codes of disease of interest that is used to cluster the patients
#' #'@param kmax Maximum threshold of number of clusters that is defined for mode-based cluster function
...
#'
#'
#' analysis_cluster=function(input,clusterSubject,kmax,itermax){
#'   library(reshape2)
#'   library(fpc)
#'
#'   L=list()
...
#'   CSR2=HDclassif::hddc( ClusterObject, K = 1:kmax, model =c("akjbkqkdk"), threshold = 0.2,
