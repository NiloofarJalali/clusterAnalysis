#
# cluster_plot=function(L,ClusterSubject,n){
#
#    library(ggplot2)
#    Gplot=function(input,ClusterSubject,n){
#     gautdata=input[input$Phenotype %in% ClusterSubject,]
#     gautdata=unique(gautdata[,c("PATIENT_ID","Phenoype")])
...
#     return(d)}
#
#   xdG=lapply(L,function(x) Gplot(x,ClusterSubject,n))
#
